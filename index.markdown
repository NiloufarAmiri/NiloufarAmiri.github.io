...
<div style="display: flex; align-items: center; gap: 20px;">
  ...
  <div style="text-align: justify;">
    ...
    <p>I have valuable experience working with soft rehabilitation technologies, including the development of a soft glove orthosis. In addition, I am deeply interested in mentoring and teaching, with extensive experience as a teaching assistant across various engineering courses.</p>
  </div>
